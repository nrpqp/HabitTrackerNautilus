...
El recorrido SHALL adaptarse al nivel de dispositivo activo. A partir del nivel 2 se representa con una traza luminosa continua sobre el canvas de efectos. En el nivel 1 se representa con el mismo encendido escalonado de las celdas de la racha, sin traza y sin canvas. En el nivel 0 no hay recorrido ni estallido.

#### Scenario: Recorrido con traza

- **WHEN** el usuario extiende una racha y el nivel activo es 2 o superior
...
- **WHEN** el usuario extiende una racha y el nivel activo es 0
