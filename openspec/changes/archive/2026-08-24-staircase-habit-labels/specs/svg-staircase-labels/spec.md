...
El sistema SHALL renderizar el nombre de cada hábito dentro del SVG, en la zona del hueco (arco vacío de 60°, entre los ángulos ~210° y ~270°), uno por anillo, orientado radialmente desde el centro hacia el exterior.
...
- **THEN** cada label está centrado verticalmente en el rango de radios de su anillo correspondiente
